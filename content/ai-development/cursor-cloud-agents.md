...
1. **High-throughput execution** with meaningful parallel agent capacity.
2. **Proof-centric QA** through self-testing runs that can include screenshots and videos.
...
- the desktop app
- the web experience at `cursor.com/agents`
- Slack
- Linear
- GitHub
...
- your top priority is lowest possible cost and GitHub-native flow: [GitHub Copilot Cloud Agent](/ai-development/github-copilot-cloud-agent)
- you want full autonomous lifecycle ownership with minimal oversight: [Devin AI](/ai-development/devin-ai)
- you need stronger compliance posture or JetBrains-centric defaults: [Windsurf](/ai-development/windsurf)
- you want cheapest paid cloud entry regardless of feature depth: [OpenAI Codex Cloud](/ai-development/openai-codex-cloud)

## How to Use Cursor Cloud Agents Without Cost Drift

1. Route low-complexity tasks to lower-cost model paths.
2. Reserve premium model runs for architecture and risky refactors.
3. Cap concurrent runs to your review bandwidth.
4. Use video evidence selectively for high-risk UI and workflow changes.
